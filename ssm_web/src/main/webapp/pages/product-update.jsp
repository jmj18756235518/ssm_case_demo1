...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<form action="${pageContext.request.contextPath}/product/updateProductById"
			  method="post">
			<!-- 正文区域 -->
			<%--隐藏域--%>
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									   id="datepicker-a3" value="${product.departureTimeStrUp}" name="departureTime">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="cityName"
								   value="${product.cityName}" placeholder="出发城市">
						</div>
